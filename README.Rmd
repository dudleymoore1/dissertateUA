...
# `dissertateUA` `v`r packageVersion("dissertateUA")`` <img src="inst/dissertateUSU_hex.png" align="right" width="30%" height="30%"/>
...
You can install `dissertateUA` with:

``` r
remotes::install_github("dudleymoore1/dissertateUA")
```
